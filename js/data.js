...
const WORKOUT_PLAN = {
  monday: {
    day: 1,
    title: '背宽 + 后束（主攻日）',
    subtitle: '背阔肌、肩胛下压、后束 · 避免耸肩借力',
    emoji: '🏋️',
    exercises: [
      { name: '面拉 Face Pull（热身）', sets: 2, repsMin: 15, repsMax: 20, rest: '30s', note: '激活肩袖和下斜方，不做到力竭' },
      { name: 'Y-T-W-L 伸展', sets: 2, repsMin: 8, repsMax: 10, rest: '30s', note: '慢速控制，先找肩胛位置' },
      { name: '辅助引体向上（正握/中立握）', sets: 4, repsMin: 6, repsMax: 10, rest: '90s', note: '先沉肩再拉，保留1~2次余力' },
      { name: '宽握高位下拉', sets: 3, repsMin: 8, repsMax: 12, rest: '75s', note: '肘向下夹，拉到锁骨附近，肩胛下沉' },
      { name: '坐姿绳索划船（宽握把）', sets: 3, repsMin: 10, repsMax: 12, rest: '75s', note: '肩胛后收下沉，胸口打开' },
      { name: '单臂哑铃划船', sets: 2, repsMin: 10, repsMax: 12, rest: '60s', note: '每侧单做，重量适中，避免身体扭转借力' },
      { name: '反向蝴蝶机', sets: 3, repsMin: 12, repsMax: 15, rest: '45s', note: '后束发力，胸贴靠垫，肩膀远离耳朵' },
      { name: '上斜方拉伸（收尾）', sets: 2, repsMin: 20, repsMax: 30, rest: '-', note: '收尾放松，轻柔不硬拽' }
    ]
  },
  tuesday: {
    day: 2,
    title: '肩中束 + 三头（控制总量）',
    subtitle: '肩宽优先，保留少量前束 · 三头补长头和外侧头',
    emoji: '💪',
    exercises: [
      { name: '面拉 Face Pull（热身）', sets: 2, repsMin: 15, repsMax: 15, rest: '30s', note: '只做激活，不当正式大强度' },
      { name: '坐姿哑铃侧平举', sets: 4, repsMin: 12, repsMax: 20, rest: '45s', note: '轻重量、顶峰停1秒、全程沉肩' },
      { name: '单臂绳索侧平举', sets: 3, repsMin: 15, repsMax: 20, rest: '45s', note: '补足中束张力，身体保持稳定' },
      { name: '绳索前平举（可选轻量）', sets: 2, repsMin: 12, repsMax: 15, rest: '45s', note: '若肩前侧紧张可取消' },
      { name: '反向蝴蝶机', sets: 2, repsMin: 12, repsMax: 15, rest: '45s', note: '维持后束，不和周一抢恢复' },
      { name: '绳索下压', sets: 3, repsMin: 10, repsMax: 15, rest: '45s', note: '肘固定，慢放' },
      { name: '绳索过顶臂屈伸', sets: 3, repsMin: 12, repsMax: 15, rest: '45s', note: '补三头长头，肩不耸' },
      { name: '上斜方拉伸（收尾）', sets: 2, repsMin: 20, repsMax: 30, rest: '-', note: '收尾放松' }
    ]
  },
  wednesday: {
    day: 3,
    title: '腿 + 髋 + 核心（补短板日）',
    subtitle: '不追极限重量 · 补足下肢、髋铰链和核心稳定',
    emoji: '🦵',
    exercises: [
      { name: '动态热身：髋、踝、腿后侧', sets: 1, repsMin: 6, repsMax: 8, rest: '-', note: '单位分钟，为深蹲和髋铰链做准备' },
      { name: '高脚杯深蹲或腿举', sets: 4, repsMin: 8, repsMax: 12, rest: '90s', note: '膝盖跟脚尖方向一致，保留1~2次余力' },
      { name: '罗马尼亚硬拉', sets: 3, repsMin: 8, repsMax: 10, rest: '90s', note: '髋向后坐，背部保持中立' },
      { name: '保加利亚分腿蹲或箭步蹲', sets: 3, repsMin: 8, repsMax: 12, rest: '75s', note: '每侧单做，单腿稳定，别塌膝' },
      { name: '腿弯举', sets: 3, repsMin: 10, repsMax: 15, rest: '60s', note: '补腘绳肌，慢放控制' },
      { name: '提踵', sets: 3, repsMin: 12, repsMax: 20, rest: '45s', note: '顶峰停顿，小腿收缩充分' },
      { name: '平板支撑或死虫', sets: 3, repsMin: 30, repsMax: 45, rest: '45s', note: '单位秒，核心稳定，不憋气' },
      { name: '肩颈轻拉伸', sets: 2, repsMin: 20, repsMax: 20, rest: '-', note: '每侧20秒，只做恢复，不增加肩部训练量' }
    ]
  },
  thursday: {
    day: 4,
    title: '手臂维度 + 轻后束',
    subtitle: '二头、三头、肱肌 · 肩后束少量维持',
    emoji: '💪',
    exercises: [
      { name: '面拉 Face Pull（热身）', sets: 2, repsMin: 15, repsMax: 15, rest: '30s', note: '肩袖预热' },
      { name: '杠铃弯举', sets: 4, repsMin: 8, repsMax: 12, rest: '60s', note: '二头主项，肘固定，顶峰收紧' },
      { name: '器械牧师凳弯举', sets: 3, repsMin: 10, repsMax: 12, rest: '60s', note: '持续张力，底部别完全放松' },
      { name: '绳索锤式弯举', sets: 3, repsMin: 12, repsMax: 15, rest: '45s', note: '补肱肌和前臂厚度，手腕中立别甩' },
      { name: '绳索下压', sets: 4, repsMin: 10, repsMax: 15, rest: '45s', note: '三头主项，肘夹紧不动' },
      { name: '绳索过顶臂屈伸', sets: 3, repsMin: 12, repsMax: 15, rest: '45s', note: '补三头长头，肩不耸' },
      { name: '反向蝴蝶机（轻量）', sets: 2, repsMin: 15, repsMax: 15, rest: '45s', note: '只维持后束感觉，不抢恢复' },
      { name: '上斜方拉伸（收尾）', sets: 2, repsMin: 20, repsMax: 30, rest: '-', note: '收尾放松' }
    ]
  },
  friday: {
    day: 5,
    title: '轻量综合 + 球赛日',
    subtitle: '上午只做唤醒和泵感 · 给下午球赛留体能',
    emoji: '🏀',
    exercises: [
      { name: '面拉 Face Pull', sets: 2, repsMin: 15, repsMax: 15, rest: '30s', note: '肩袖唤醒' },
      { name: '辅助引体向上（技术组）', sets: 2, repsMin: 3, repsMax: 5, rest: '60s', note: '保留3~4次余力，不做到力竭' },
      { name: '坐姿划船器械', sets: 2, repsMin: 10, repsMax: 12, rest: '60s', note: '轻中重量，背部找感觉' },
      { name: '哑铃侧平举', sets: 2, repsMin: 15, repsMax: 20, rest: '45s', note: '轻量泵感，全程沉肩' },
      { name: '绳索弯举', sets: 2, repsMin: 12, repsMax: 15, rest: '45s', note: '手臂轻量，不做到力竭' },
      { name: '绳索下压', sets: 2, repsMin: 12, repsMax: 15, rest: '45s', note: '手臂轻量，肩膀保持下沉' },
      { name: '蝴蝶机夹胸（可选）', sets: 2, repsMin: 12, repsMax: 15, rest: '60s', note: '仅在肩无不适时做，不追重量' },
      { name: '拉伸与呼吸放松', sets: 1, repsMin: 6, repsMax: 8, rest: '-', note: '单位分钟，为球赛恢复活动度' }
    ],
    circuitNote: '周五上午只做唤醒和轻泵感；如果下午对抗强，取消胸部孤立动作。'
  }
};
